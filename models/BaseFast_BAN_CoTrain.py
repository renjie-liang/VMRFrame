...
class BaseFast_BAN_TogetherTrain(nn.Module):
    def __init__(self, configs, word_vectors):
        super(BaseFast_BAN_TogetherTrain, self).__init__()
        ...
        self.teach_model = SeqPAN(configs.teacher0, word_vectors)
...
def collate_fn_BaseFast_BAN_TogetherTrain(datas):
...
def train_engine_BaseFast_BAN_TogetherTrain(model, data, configs):
...
def infer_BaseFast_BAN_TogetherTrain(output, configs):
