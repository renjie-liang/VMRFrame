...
class BaseFast_CCA_PreTrain(nn.Module):
    def __init__(self, configs, word_vectors):
        super(BaseFast_CCA_PreTrain, self).__init__()
...
def collate_fn_BaseFast_CCA_PreTrain(datas):
    ...
    label1ds, label1ds_t0, NER_labels = [], [], []
    ...
    for d in datas:
        ...
        label1ds_t0.append(d["label1d_t0"])
    ...
    label1ds_t0, _ = pad_video_seq(label1ds_t0, max_vlen)
    label1ds_t0 = torch.stack(label1ds_t0)
...
def train_engine_BaseFast_CCA_PreTrain(model, data, configs):
    ...
    slogits_t0 = data['label1ds_t0'][:,:,0]
    elogits_t0 = data['label1ds_t0'][:,:,1]
...
def infer_BaseFast_CCA_PreTrain(output, configs):
