...
class OneTeacher_SoftLabel(nn.Module):
    def __init__(self, configs, word_vectors):
        super(OneTeacher_SoftLabel, self).__init__()
...
def collate_fn_OneTeacher_SoftLabel(datas):
...
def train_engine_OneTeacher_SoftLabel(model, data, configs):
...
def infer_OneTeacher_SoftLabel(output, configs):
